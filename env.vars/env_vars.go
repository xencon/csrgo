...
func KubeAddonExpected() string {
	KubeAddonExpected := "k8s.gcr.io/kube-addon-manager:v9.0"
	return KubeAddonExpected
}

//TODO Populate with all expected values for all tests


//Istio Application Platform Expected Image Values
